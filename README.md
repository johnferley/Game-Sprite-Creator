...
2. Render Setup
   ...
   * Camera 1 to Camera 4
     ...
     This parent must be an empty positioned at the origin and must have a camera parent.
   ...
   * Output
     ...
     The parent must be an empty positioned at the origin and must have a chid object.
     ...
     * Based on Sprite Sheet Parent:
     ...
     Where Object Parent is positioned at the origin and Sprite Sheet Parent is an empty positioned at the origin with at least one child.
   ...
   * Global
     ...
     The parent, if there is one, must be an empty positioned at the origin, and must have a chid object.
